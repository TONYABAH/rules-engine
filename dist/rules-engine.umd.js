(function (global, factory) {
  ...
  (global = global || self, factory(global.RulesEngine = {}));
    ...
    _proto.matchParenthesis = function matchParenthesis(tokens) {
      ...
      for (var _i2 = 0; _i2 < closes.length; _i2++) {
        ...
        if (_match === -1) {
          ...
          this.error(_msg /* , close, closes[i][0]*/);
          break;
        }
      }
    };
   ...
   */
  var Interpreter /* extends NodeVisitor*/ = /*#__PURE__*/function () {
  ...
  var Engine = /*#__PURE__*/function () {
    ...
    _proto.fireDoneEvent = function fireDoneEvent() {
    ...
    _proto.prompt = function prompt(name) {
      ...
      var prompt = this.knowledgebase.prompts[_name];
    ...
    _proto.input = function input(_input) {
      try {
        ...
        var data = this.setAttribute(_input);
        // console.log(data)
        return data;
      } catch (e) {
        return this.raiseScriptError(e);
  ...
  var EventEmmiter = {
    subscribe: function subscribe(topic, listener) {
      ...
      var index = channels[topic].push(listener) - 1;
    ...
    _proto.checkVarableDeclarations = function checkVarableDeclarations() {
      ...
      Object.keys(this.attributes).forEach(function (k) {
        ...
        if (!(_this2.inferences[k] || _this2.prompts[k])) {
          _this2.warn('No input prompt for attribute ' + k, a);
          ...
          try {
            ...
            return Promise.resolve(tokenizer.tokenize(text)).then(function (tokens) {
              setTimeout(function () {
                ...
                _this6.checkVarableDeclarations();
    ...
    function checkParam(line) {
      for (var i = 0; i < line.length; i++) {
        ...
        if (_token2.type === LPAREN) {
          ...
          var msg = "'}' at " + _token2.row + " col: " + _token2.column + " has no matching opening parenthesis ";
  ...
  var KnowledgebaseCompiler = /*#__PURE__*/function (_Parser) {
    ...
    _proto.attachListeners = function attachListeners() {
      ...
      this.subscribe("condition", function (data) {
        var keyword = data[0],
          ...
          row = data[3],
          op = data[4];
        return _this2.addCondition(keyword, left, right, op, row
    ...
    _proto.addNewLine = function addNewLine() {
      // do nothing
    }
    /**
     *
  ...
  var Ux = /*#__PURE__*/function (_CustomEvent) {
    ...
    _proto.explain = function explain() {
      //ps.publish( 'explain' )
    };
  ...
  var Ui = /*#__PURE__*/function (_CustomEvent) {
    ...
    _proto.loadConsolePanel = function loadConsolePanel() {
      try {
        ...
        _this8.input.focus();
        _this8.container = document.getElementById(container);
        // let doc = document.createDocumentFragment()
        // let runpanel = doc.getElementById( container )
        // let input = doc.getElementById( inputId )
        // this.stylePanel( runpanel )
...
//# sourceMappingURL=rules-engine.umd.js.map
